...
const ModelDialogFormComponent:React.FC<IDialogFormData>= ({singleUserData, dialogState, setDialogState}) => {
            ...
            >
                ...
                <DialogBody className={`${rubikFont.className} text-xs text-gray-800 flex flex-col gap-y-3 overflow-hidden h-full w-full items-center justify-center rounded-3xl bg-gray-100`}>
                    ...
                    <div className="overflow-hidden overflow-y-scroll h-full w-full flex flex-col px-3 py-4 gap-y-10">
                        ...
                        <Input 
                            readOnly
                            value={singleUserData!.phone_no}
                            label="Phone Number format(+xxx xxxxxxxxxx)" type="tel" 
                            color='orange' size='lg' 
                        ...
                        <Input 
                            readOnly
                            value={singleUserData!.portfolio_links}
                            label="Portfolio Link(s)" type="text" 
                            color='orange' size='lg' 
                            className='bg-white px-4 py-6 shadow-sm shadow-gray-300'
                        />
                        ...
                        <Input 
                            readOnly
                            value={singleUserData!.design_category}
                        ...
                        <Textarea 
                            readOnly
                            value={singleUserData!.description} 
                            label="Description"
                        ...
                        <div className='flex flex-col gap-y-2 font-light'>
                            ...
                            <Image alt='' quality={100} src={singleUserData!.picture} width={100} height={0} className='flex w-full h-full object-cover rounded-3xl'></Image>
                        </div>
...
export default ModelDialogFormComponent;

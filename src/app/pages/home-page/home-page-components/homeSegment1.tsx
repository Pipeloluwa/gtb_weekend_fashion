...
interface HomeSegment1Props{
    blackOutDone: boolean;
}


const HomeSegment1:React.FC<HomeSegment1Props> = ({blackOutDone}) => {
...

                {
                    ...
                    <>
                        ...
                        <motion.div 
                            ...
                            <Button onClick={() => {}} className={`${rubikFont.className} tracking-widest text-[15px] bg-orange-900 big-button sm:hover:bg-[#f0f0f0] sm:hover:text-orange-800 sm:hover:transition-colors hover:ease-linear sm:hover:duration-500`}  placeholder={""} onPointerEnterCapture={ () => {}} onPointerLeaveCapture={ () => {}}>
                                Explore
                            </Button>
                        </motion.div>

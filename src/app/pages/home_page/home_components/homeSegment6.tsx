    ...
    <div className='flex flex-col gap-y-8'>
        <div className='w-full mx-auto flex flex-col justify-center items-center gap-y-6'>
            ...
            <div className={`${rubikFont.className} relative flex flex-col items-center h-[500px] w-full bg-gray-100`}>
                <Image quality={100} alt='picture' src="/images/pictures/sunglasses-1284255_1280.jpg" width={350} height={300} className='absolute top-0 bottom-0 left-0 right-0 flex w-full h-full object-cover'>
                </Image>


               <div className='absolute left-0 right-0 top-0 bottom-0 p-8 bg-black/40 '>
                    <p className='w-[50%] text-center mx-auto text-white'>
                        Enroll Now and become part of a spectacular event that will bring your creativity to life.
                        Step into the spotlight and make a lasting impression!
                    </p>

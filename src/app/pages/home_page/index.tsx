...
import HomeSegment1 from './home_components/homeSegment1';
import IntroShow from './home_components/introShow';
import HomeSegment2 from './home_components/homeSegment2';
import { useDispatch } from 'react-redux';
import { setNavBg } from '@/app/state_management/reducers/nav_bg_state';
import { pacificoFont } from '@/app/fonts/fontsConfig';
import HomeSegment3 from './home_components/homeSegment3';
import Countdown from 'react-countdown';
import HomeSegment4 from './home_components/homeSegment4';
import Footer from '@/app/general_components/footer';
import HomeSegmentt5 from './home_components/homeSegment5';
import HomeSegment6 from './home_components/homeSegment6';
import HomeSegment7 from './home_components/homeSegment7';
import HomeSegment8 from './home_components/homeSegment8';
